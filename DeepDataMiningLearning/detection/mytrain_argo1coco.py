...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/data/cmpe249-fa23/Argoverse/Argoverse-1.1/images/", type=str, help="dataset path")
    parser.add_argument("--annotationfile", default="/data/cmpe249-fa23/argo1COCO/", type=str, help="dataset annotion file path, e.g., coco json file")
    parser.add_argument(
        "--dataset",
        default="argo1coco", 
        type=str,
    ...
    parser.add_argument("--output-dir", default="/data/cmpe249-fa23/argo1COCO/trainoutput", type=str, help="path to save outputs")
    parser.add_argument("--resume", default="", type=str, help="path of checkpoint") ##/data/cmpe249-fa23/argo1COCO/trainoutput/cusrcnn_model_5.pth
    ...
    for epoch in range(args.start_epoch, args.epochs+1):
        ...
        if epoch % args.saveeveryepoch == 0 or epoch == args.epochs:
            if args.output_dir:
                ...
                if args.model.split('_')[0] == "customrcnn":
                    file_name_to_save = "cusrcnn_model_"
                    checkpoint_name = "cusrcnn_checkpoint.pth"
                else:
                    file_name_to_save = "model_"
                    checkpoint_name = "checkpoint.pth"
                utils.save_on_master(checkpoint, os.path.join(args.output_dir, file_name_to_save+str(epoch)+'.pth'))
                utils.save_on_master(checkpoint, os.path.join(args.output_dir, checkpoint_name))
